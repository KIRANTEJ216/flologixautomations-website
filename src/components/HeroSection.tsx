  ...
  return (
    <section className="relative min-h-screen overflow-hidden pt-32 pb-20">
      ...
      <div ref={ref} className="relative mx-auto max-w-7xl px-4 sm:px-6 text-center">
        ...
        >
          We are an AI automation agency building AI automations workflow automation, AI agents, WhatsApp & Telegram chatbots, RAG systems, invoice OCR and end-to-end business process automation that eliminate repetitive tasks, reduce costs by up to 70%, and help startups and enterprises scale faster.
        </p>
